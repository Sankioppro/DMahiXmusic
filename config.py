...
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME", "⋞♥‌‌⃝⃚Ⓜ︎𝖆፝֟፝֟፝֟፝֟፝֟፝‌𝖍𝖎‌Ⓢ︎‌𝖍𝖆፝֟፝֟፝֟፝֟፝֟፝‌𝖗‌𝖒𝖆𝄄𝖒𝔲⵿፝֟፝֟‌𝔰𝔧𝒄𝐁𖧋⵿𐍒🎧")
OWNER_ID = list(map(int, getenv("OWNER_ID", "").split()))
HEROKU_API_KEY = getenv("HEROKU_API_KEY", None)
HEROKU_APP_NAME = getenv("HEROKU_APP_NAME", None)
UPSTREAM_REPO = getenv("UPSTREAM_REPO", "https://github.com/Sankioppro/DMahiXmusic")
